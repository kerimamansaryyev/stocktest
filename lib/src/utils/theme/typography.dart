...
enum AppTypographyColor implements Color {
  lightOrdinary(Color.fromRGBO(32, 14, 50, 1)),
  lightActionButton(Color.fromRGBO(255, 255, 255, 1)),
  errorColor(Colors.redAccent);

  const AppTypographyColor(this.color);
